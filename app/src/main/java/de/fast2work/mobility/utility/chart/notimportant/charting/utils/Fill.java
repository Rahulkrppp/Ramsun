...
public class Fill
{
    ...
    {
        return de.fast2work.mobility.utility.chart.notimportant.charting.utils.Utils.getSDKInt() >= 18;
    }

    private void ensureClipPathSupported()
    {
        if (de.fast2work.mobility.utility.chart.notimportant.charting.utils.Utils.getSDKInt() < 18)
        {
