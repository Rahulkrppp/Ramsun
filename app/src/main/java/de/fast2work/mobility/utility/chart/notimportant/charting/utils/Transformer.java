...
public class Transformer {
    ...
    protected de.fast2work.mobility.utility.chart.notimportant.charting.utils.ViewPortHandler mViewPortHandler;
     ...
     * @return
     */
    public de.fast2work.mobility.utility.chart.notimportant.charting.utils.MPPointD getValuesByTouchPoint(float x, float y) {

        de.fast2work.mobility.utility.chart.notimportant.charting.utils.MPPointD result = de.fast2work.mobility.utility.chart.notimportant.charting.utils.MPPointD.getInstance(0, 0);
        getValuesByTouchPoint(x, y, result);
        return result;
    }

    public void getValuesByTouchPoint(float x, float y, de.fast2work.mobility.utility.chart.notimportant.charting.utils.MPPointD outputPoint) {
     ...
     * @return
     */
    public de.fast2work.mobility.utility.chart.notimportant.charting.utils.MPPointD getPixelForValues(float x, float y) {
