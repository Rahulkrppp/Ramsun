 ...
 */
public abstract class ChartData<T extends IDataSet<? extends de.fast2work.mobility.utility.chart.notimportant.charting.data.Entry>> {
     ...
     * @param dataSetIndex
     */
    public void addEntry(de.fast2work.mobility.utility.chart.notimportant.charting.data.Entry e, int dataSetIndex) {
     ...
     * @param axis
     */
    protected void calcMinMax(de.fast2work.mobility.utility.chart.notimportant.charting.data.Entry e, AxisDependency axis) {
     ...
     * @param dataSetIndex
     */
    public boolean removeEntry(de.fast2work.mobility.utility.chart.notimportant.charting.data.Entry e, int dataSetIndex) {
    ...
    public boolean removeEntry(float xValue, int dataSetIndex) {
        ...
        de.fast2work.mobility.utility.chart.notimportant.charting.data.Entry e = dataSet.getEntryForXValue(xValue, Float.NaN);
