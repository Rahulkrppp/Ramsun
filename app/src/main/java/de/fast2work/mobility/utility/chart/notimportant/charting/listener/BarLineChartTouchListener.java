...
import de.fast2work.mobility.utility.chart.notimportant.charting.charts.HorizontalBarChart;
...
public class BarLineChartTouchListener extends ChartTouchListener<BarLineChartBase<? extends BarLineScatterCandleBubbleData<?
    ...
    private void performDrag(MotionEvent event, float distanceX, float distanceY) {
        ...
        de.fast2work.mobility.utility.chart.notimportant.charting.listener.OnChartGestureListener l = mChart.getOnChartGestureListener();
