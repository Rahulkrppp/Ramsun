...
class TicketView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    init {
        ...
        dashPaint.color = Color.YELLOW // Change to desired border color
        dashPaint.style = Paint.Style.STROKE
        dashPaint.strokeWidth = getDp(2f).toFloat()
    ...
    fun setAnchor(view1: View?, view2: View?) {
        ...
        val rect = Rect()
        //view1?.setBackgroundColor(Color.parseColor("#E3FFCE"))
...
class TicketView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    init {
        ...
        borderPaint.color = Color.parseColor("#4D39B27B")  // Default border color
        borderPaint.style = Style.STROKE
        borderPaint.strokeWidth = getDp(1f).toFloat()  // Default border width
    }
    ...
    private fun drawHoles(canvas: Canvas) {
        ...
        for (i in 0 until count) {
            ...
            circlesPath.addCircle(positionCircle + halfCircleSpace, -circleRadius / 4, radius, Path.Direction.CW)
        }
        ...
        // Draw borders
        val borderPath = Path(circlesPath)
