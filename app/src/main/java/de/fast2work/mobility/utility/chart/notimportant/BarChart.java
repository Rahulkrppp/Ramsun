...
public class BarChart extends View {
    ...
    public BarChart(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //GD.setColors(new int[]{0xFFC540B2, 0xFFC540B2, 0xFFC540B2});


//        drawable = new ColorDrawable(Color.parseColor(color));
//        drawablePlace = new ColorDrawable(Color.WHITE);
//
...
//        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_IN));
    ...
    public void setColor(String colorCode,Context context){
        this.color = colorCode;
        drawable = new ColorDrawable(Color.parseColor(color));
        drawablePlace = new ColorDrawable(Color.WHITE);
       // drawablePlace = new ColorDrawable(Color.parseColor(backGround));
