package de.fast2work.mobility.utility.chart.notimportant.charting.animation;
...
public class ChartAnimator {
    ...
    public void animateX(int durationMillis) {
        animateX(durationMillis, de.fast2work.mobility.utility.chart.notimportant.charting.animation.Easing.Linear);
    }
    ...
    public void animateXY(int durationMillisX, int durationMillisY) {
        animateXY(durationMillisX, durationMillisY, de.fast2work.mobility.utility.chart.notimportant.charting.animation.Easing.Linear, de.fast2work.mobility.utility.chart.notimportant.charting.animation.Easing.Linear);
    }
