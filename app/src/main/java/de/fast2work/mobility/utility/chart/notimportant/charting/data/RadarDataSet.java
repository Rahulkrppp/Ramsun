...
import de.fast2work.mobility.utility.chart.notimportant.charting.data.LineRadarDataSet;
import de.fast2work.mobility.utility.chart.notimportant.charting.data.RadarEntry;
import de.fast2work.mobility.utility.chart.notimportant.charting.interfaces.datasets.IRadarDataSet;
import de.fast2work.mobility.utility.chart.notimportant.charting.utils.ColorTemplate;

import java.util.ArrayList;
import java.util.List;

public class RadarDataSet extends LineRadarDataSet<de.fast2work.mobility.utility.chart.notimportant.charting.data.RadarEntry> implements IRadarDataSet {
    ...
    public RadarDataSet(List<de.fast2work.mobility.utility.chart.notimportant.charting.data.RadarEntry> yVals, String label) {
        super(yVals, label);
    }
    ...
    @Override
    public DataSet<de.fast2work.mobility.utility.chart.notimportant.charting.data.RadarEntry> copy() {
        List<de.fast2work.mobility.utility.chart.notimportant.charting.data.RadarEntry> entries = new ArrayList<RadarEntry>();
