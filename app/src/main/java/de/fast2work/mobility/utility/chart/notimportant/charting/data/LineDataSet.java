...
import de.fast2work.mobility.utility.chart.notimportant.charting.formatter.DefaultFillFormatter;
...
public class LineDataSet extends LineRadarDataSet<de.fast2work.mobility.utility.chart.notimportant.charting.data.Entry> implements ILineDataSet {
    ...
    public LineDataSet(List<de.fast2work.mobility.utility.chart.notimportant.charting.data.Entry> yVals, String label) {
        super(yVals, label);
