package de.fast2work.mobility.utility.chart.notimportant.charting.components;

import android.graphics.DashPathEffect;
import android.graphics.Paint;

import de.fast2work.mobility.utility.chart.notimportant.charting.components.ComponentBase;
import de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry;
...
public class Legend extends ComponentBase {
     ...
     */
    private de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry[] mEntries = new de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry[]{};

    /**
     * Entries that will be appended to the end of the auto calculated entries after calculating the legend.
     * (if the legend has already been calculated, you will need to call notifyDataSetChanged() to let the changes take effect)
     */
    private de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry[] mExtraEntries;
     ...
     * @param entries
     */
    public Legend(de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry[] entries) {
        this();
     ...
     * @param entries
     */
    public void setEntries(List<de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry> entries) {
        mEntries = entries.toArray(new de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry[entries.size()]);
    }

    public de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry[] getEntries() {
        return mEntries;
    }
    ...
    public float getMaximumEntryWidth(Paint p) {
        ...
        for (de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry entry : mEntries) {
    ...
    public de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry[] getExtraEntries() {

        return mExtraEntries;
    }

    public void setExtra(List<de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry> entries) {
        mExtraEntries = entries.toArray(new de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry[entries.size()]);
    }

    public void setExtra(de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry[] entries) {
        if (entries == null)
            entries = new de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry[]{};
    ...
    public void setExtra(int[] colors, String[] labels) {
        ...
        List<de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry> entries = new ArrayList<>();

        for (int i = 0; i < Math.min(colors.length, labels.length); i++) {
            final de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry entry = new de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry();
     ...
     */
    public void setCustom(de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry[] entries) {
     ...
     *   notifyDataSetChanged() is needed to auto-calculate the legend again)
     */
    public void setCustom(List<de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry> entries) {
    ...
    public void calculateDimensions(Paint labelpaint, ViewPortHandler viewPortHandler) {
        ...
        de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry[] entries = mEntries;
        ...
        switch (mOrientation) {
            case VERTICAL: {
                ...
                for (int i = 0; i < entryCount; i++) {
                    ...
                    de.fast2work.mobility.utility.chart.notimportant.charting.components.LegendEntry e = entries[i];
