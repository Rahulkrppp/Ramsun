...
import de.fast2work.mobility.utility.chart.notimportant.charting.utils.ObjectPool;
 ...
 */
public final class FSize extends de.fast2work.mobility.utility.chart.notimportant.charting.utils.ObjectPool.Poolable{
    ...
    private static de.fast2work.mobility.utility.chart.notimportant.charting.utils.ObjectPool<FSize> pool;

    static {
        pool = de.fast2work.mobility.utility.chart.notimportant.charting.utils.ObjectPool.create(256, new FSize(0,0));
