...
@HiltViewModel
class SignUpViewModule @Inject constructor(private val repository: AuthenticationRepoHelper,private val repository1: AuthenticationRepoHelper) : BaseViewModel() {
